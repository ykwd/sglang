...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Script to benchmark concurrent single-turn requests to a server."
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=512,
        help="Length of input tokens for each request",
    )
    parser.add_argument(
        "--output-length",
        type=int,
        default=64,
        help="Length of output tokens for each request",
    )
    parser.add_argument(
        "--num-requests",
        type=int,
...
class WorkloadGenerator:
    def __init__(self, args):
        ...
        self.total_requests = args.num_requests

        # Generate random prompts for all requests
        ...
        # Initialize ready queue with all requests
        init_requests = [
        ...
        self.pbar = tqdm(total=args.num_requests)
    ...
    def run(self):
        ...
        print(f"  Input length: {performance_data['summary']['input_length']} tokens")
        print(f"  Output length: {performance_data['summary']['output_length']} tokens")
...
if __name__ == "__main__":
    ...
    print(f"Running benchmark with request rate: {args.request_rate}")
